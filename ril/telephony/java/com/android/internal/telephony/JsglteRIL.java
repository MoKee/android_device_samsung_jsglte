...
/**
 * RIL customization for Galaxy S4 4gLTE devices.
 *
 *
 * {@hide}
 */
public class JsglteRIL extends RIL implements CommandsInterface {
    ...
    public JsglteRIL(Context context, int preferredNetworkType,
