...
PRODUCT_COPY_FILES += \
   $(LOCAL_PATH)/configs/cred.conf:system/vendor/etc/wifi/cred.conf \
...
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/wifi/hostapd.accept:system/vendor/etc/hostapd/hostapd.accept \
    $(LOCAL_PATH)/wifi/hostapd_default.conf:system/vendor/etc/hostapd/hostapd_default.conf \
    $(LOCAL_PATH)/wifi/hostapd.deny:system/vendor/etc/hostapd/hostapd.deny
